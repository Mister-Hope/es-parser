...
evaluateMap = Object.assign({}, declaration_1.default, expression_1.default, module_1.default, pattern_1.default, statement_1.default, {
    ...
    VariableDeclarator: function (_node, _scope) {
        throw new Error('不应出现');
    },
    Property: function (_node, _scope, _computed) {
        throw new Error('不应出现');
    },
    Super: function (node, _scope) {
        throw new Error(node.type + " \u672A\u5B9E\u73B0");
    },
    TemplateElement: function (node, _scope) {
        throw new Error(node.type + " \u672A\u5B9E\u73B0");
    },
    SpreadElement: function (node, _scope) {
        throw new Error(node.type + " \u672A\u5B9E\u73B0");
    },
...
var Scope = (function () {
    ...
    Scope.prototype.get = function (varName) {
        var name = "@" + varName;
        if (this.variables.hasOwnProperty(name))
            return this.variables[name];
        else if (this.parent)
...
Object.defineProperty(exports, "__esModule", { value: true });
var moduleHandler = {
    MethodDefinition: function (node, _scope) {
        throw new Error(node.type + " \u672A\u5B9E\u73B0");
    },
    ImportDeclaration: function (node, _scope) {
        throw new Error(node.type + " \u672A\u5B9E\u73B0");
    },
    ExportNamedDeclaration: function (node, _scope) {
        throw new Error(node.type + " \u672A\u5B9E\u73B0");
    },
    ExportDefaultDeclaration: function (node, _scope) {
        throw new Error(node.type + " \u672A\u5B9E\u73B0");
    },
    ExportAllDeclaration: function (node, _scope) {
        throw new Error(node.type + " \u672A\u5B9E\u73B0");
    },
    ImportSpecifier: function (node, _scope) {
        throw new Error(node.type + " \u672A\u5B9E\u73B0");
    },
    ImportDefaultSpecifier: function (node, _scope) {
        throw new Error(node.type + " \u672A\u5B9E\u73B0");
    },
    ImportNamespaceSpecifier: function (node, _scope) {
        throw new Error(node.type + " \u672A\u5B9E\u73B0");
    },
    ExportSpecifier: function (node, _scope) {
        throw new Error(node.type + " \u672A\u5B9E\u73B0");
    }
};
...
Object.defineProperty(exports, "__esModule", { value: true });
var patternHandler = {
    ObjectPattern: function (node, _scope) {
        throw new Error(node.type + " \u672A\u5B9E\u73B0");
    },
    ArrayPattern: function (node, _scope) {
        throw new Error(node.type + " \u672A\u5B9E\u73B0");
    },
    RestElement: function (node, _scope) {
        throw new Error(node.type + " \u672A\u5B9E\u73B0");
    },
    AssignmentPattern: function (node, _scope) {
        throw new Error(node.type + " \u672A\u5B9E\u73B0");
    }
};
exports.default = patternHandler;
...
var statementHandler = {
    ExpressionStatement: function (node, scope) {
        eval_1.default(node.expression, scope);
    },
    BlockStatement: function (block, scope) {
        var blockScope = new scope_1.Scope('block', scope);
    ...
    EmptyStatement: function (_node, _scope) { },
    DebuggerStatement: function (_node, _scope) {
        debugger;
    },
    WithStatement: function (_node, _scope) {
    ...
    IfStatement: function (node, scope) {
        if (eval_1.default(node.test, scope))
            return eval_1.default(node.consequent, scope);
        else if (node.alternate)
            return eval_1.default(node.alternate, scope);
    },
    SwitchStatement: function (node, scope) {
        var discriminant = eval_1.default(node.discriminant, scope);
        var newScope = new scope_1.Scope('switch', scope);
        var matched = false;
        for (var _i = 0, _a = node.cases; _i < _a.length; _i++) {
            var $case = _a[_i];
            if (!matched &&
                (!$case.test || discriminant === eval_1.default($case.test, newScope)))
                matched = true;
            if (matched) {
    ...
    ThrowStatement: function (node, scope) {
        throw eval_1.default(node.argument, scope);
    },
    TryStatement: function (node, scope) {
        try {
            return eval_1.default(node.block, scope);
        }
        catch (err) {
            if (node.handler) {
            ...
            if (node.finalizer)
                return eval_1.default(node.finalizer, scope);
        }
    },
    ...
    ForOfStatement: function (node, _scope) {
        throw new Error(node.type + " \u672A\u5B9E\u73B0");
    }
};
